...
const targetStr = `{/* Filters & Search - Improved */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-3 bg-white p-6 rounded-[24px] border border-emerald-100 shadow-sm items-end">
        ...
        <div className="md:col-span-1">
          <button 
            ...
            className="w-full p-2.5 flex items-center justify-center text-emerald-700 bg-emerald-50 hover:bg-emerald-100 rounded-xl transition"
            title="Reset Filter"
          >
...
const replacementStr = `{/* Filters & Search - Improved */}
